...
public class ObjectFactory {
    ...
    private final static QName _MultiplicarResponse_QNAME = new QName("http://webservice/", "multiplicarResponse");
    private final static QName _DividirResponse_QNAME = new QName("http://webservice/", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://webservice/", "multiplicar");
    private final static QName _Sumar_QNAME = new QName("http://webservice/", "sumar");
    private final static QName _Dividir_QNAME = new QName("http://webservice/", "dividir");
    private final static QName _Restar_QNAME = new QName("http://webservice/", "restar");
    private final static QName _RestarResponse_QNAME = new QName("http://webservice/", "restarResponse");
    private final static QName _SumarResponse_QNAME = new QName("http://webservice/", "sumarResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "restar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "restarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "sumarResponse")
